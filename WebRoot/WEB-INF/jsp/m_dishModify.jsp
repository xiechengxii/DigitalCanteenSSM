		        ...
		        <div class="scroller" style="background:#EEEEEE">
		          <div class="scroller-inner">
		              <header class="codrops-header" style="background:#29C192;padding-top:22px;">
		                  <div class="row">
		                        <button class="btn btn-lg" style="position:relative;right:48%;padding:0 0;background-color:#29C192";font-size:;><a style="color:#fff"; class="icon icon-arrow-left" data-ajax="false" href="${pageContext.request.contextPath }/findDishInCanteen.action"></a></button>      
		                        <h1>修改菜品</h1>
		                  </div>  
		              </header>
		                    ...
		                    <div class="content clearfix">
		                        ...
		                        <!-- 菜品添加 -->
			                        <form class="form-horizontal" role="form" name = "dishUpdateForm" action="modifyDishSave.action" method="post" enctype="multipart/form-data">		        	                
			                            ...
			                            <br> 		                           
			                            <div class="row form-group">
			                                <label class="col-xs-4 control-label style1" >菜品</label>
			                                <div class="col-xs-7">
			                                    <!-- 选择菜品  -->
			                            ...
			                            <br>
			                            <div class="row form-group">
			                                <label class="col-xs-4 control-label style1" >菜品图片</label>
			                                <div class="col-xs-7">
			                            ...
			                            <br>
			                            <div class="row form-group">
			                                <label class="col-xs-4 control-label style1" >菜品日期</label>
			                                <div class="col-xs-7">
			                                    <!-- 日期控件调用，用在填入菜品的日期 -->
