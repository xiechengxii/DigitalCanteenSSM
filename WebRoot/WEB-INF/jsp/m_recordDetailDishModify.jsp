		      	...
		      	<div class="scroller" style="background:#EEEEEE">
		            <div class="scroller-inner">
		           		<header class="codrops-header" style="background:#29C192;padding-top:22px;">
		        	        <div class="row">
			        	        <button class="btn btn-lg" style="position:relative;right:48%;padding:0 0;background-color:#29C192";font-size:;><a style="color:#fff"; class="icon icon-arrow-left" data-ajax="false" href="${pageContext.request.contextPath }/muserCanteenHostPage.action"></a></button>					
								<h1>修改录入表</h1>
							</div>
						</header> 
